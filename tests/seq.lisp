...
(let ((l1 '#(1 2 3)) (l2 '#(a b c)) (l3 '#(1 2 #(a b c) 3)) (l4))
    ...
    (assert-true (and (= (vec-nth l1 1) 2) (assert-equal l1 '(1 2 3)))  (str ". line number: " (meta-line-no)))
    ...
    (assert-true (and (assert-equal (vec-remove! l1 1) '(1 3)) (assert-equal l1 '(1 3))) (str ". line number: " (meta-line-no)))
    ...
    (assert-true (and (assert-equal (vec-insert! l1 0 2) '(2)) (assert-equal l1 '(2))) (str ". line number: " (meta-line-no)))
    (assert-true (and (assert-equal (vec-insert! l1 0 1) '(1 2)) (assert-equal l1 '(1 2))) (str ". line number: " (meta-line-no)))
    (assert-true (and (assert-equal (vec-insert! l1 2 3) '(1 2 3)) (assert-equal l1 '(1 2 3))) (str ". line number: " (meta-line-no)))
    (assert-true (and (assert-equal (vec-insert! l1 1 'a) '(1 a 2 3)) (assert-equal l1 '(1 a 2 3)))) (str ". line number: " (meta-line-no)))
