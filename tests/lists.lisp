...
(let ((l1 '#(1 2 3)) (l2 '#(a b c)) (l3 '#(1 2 #(a b c) 3)) (l4))
    ...
    (if (and (= (vec-nth 1 l1) 2) (lists= l1 '(1 2 3)))
        (println "PASS 6") (println "FAIL"))
    (if (and (lists= (vec-setnth! 1 'x l1) '(1 x 3)) (lists= l1 '(1 x 3)))
    ...
    (if (and (lists= (vec-push! l1 4) '(1 x 3 4)) (lists= l1 '(1 x 3 4)))
        (println "PASS 9") (println "FAIL"))
    (setq l4 (vec-nth 2 l3))
    (vec-push! l4 'd)
    (if (and (lists= (vec-nth 2 l3) '(a b c d)) (lists= l4 (vec-nth 2 l3)))
        (println "PASS 10") (println "FAIL"))
    (if (and (= (vec-pop! l1) 4) (lists= l1 '(1 x 3)))
        (println "PASS 11") (println "FAIL"))
    (if (and (lists= (vec-remove-nth! 1 l1) '(1 3)) (lists= l1 '(1 3)))
        (println "PASS 12") (println "FAIL"))
    (if (not (vec-empty? l1))
        (println "PASS 13") (println "FAIL"))
    (if (and (lists= (vec-clear! l1) '()) (lists= l1 '()))
        (println "PASS 14") (println "FAIL"))
    (if (vec-empty? l1)
        (println "PASS 15") (println "FAIL"))
    (if (and (lists= (vec-insert-nth! 0 2 l1) '(2)) (lists= l1 '(2)))
        (println "PASS 16") (println "FAIL"))
    (if (and (lists= (vec-insert-nth! 0 1 l1) '(1 2)) (lists= l1 '(1 2)))
        (println "PASS 17") (println "FAIL"))
    (if (and (lists= (vec-insert-nth! 2 3 l1) '(1 2 3)) (lists= l1 '(1 2 3)))
        (println "PASS 18") (println "FAIL"))
    (if (and (lists= (vec-insert-nth! 1 'a l1) '(1 a 2 3)) (lists= l1 '(1 a 2 3)))
