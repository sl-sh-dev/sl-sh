...
$(echo -n "one" > $(temp-dir)/shell-read-test1.txt)
(def topen (open (str (temp-dir) "/shell-read-test1.txt") :read))
(test::assert-equal "one" (read-line topen))
(close topen)
...
$(echo -n "two" > $(temp-dir)/$xxx)
(def topen (open (str (temp-dir) "/shell-read-test2.txt") :read))
(test::assert-equal "two" (read-line topen))
(close topen)
...
$(echo -n "three" > $(temp-dir)/shell\ read\ test3.txt)
(def topen (open (str (temp-dir) "/shell read test3.txt") :read))
(test::assert-equal "three" (read-line topen))
(close topen)
