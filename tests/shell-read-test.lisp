...
$(export BIN $((str-sub $GREP 0 (- (length $GREP) 6))))
...
(test::assert-equal "y z" (str-trim $(echo {y,z})))
(test::assert-equal "x/y x/z" (str-trim $(echo x/{y,z})))
(test::assert-equal "x{/y{} x{/z}" (str-trim $(echo x\{/{y\{\},z\}})))
(test::assert-equal "x/y/a x/z/a" (str-trim $(echo x/{y,z}/a)))

(test::assert-equal "y z/1 z/2" (str-trim $(echo {y,z/{1,2}})))
(test::assert-equal "x/y x/z/1 x/z/2" (str-trim $(echo x/{y,z/{1,2}})))
(test::assert-equal "x/y/a x/z/1/a x/z/2/a" (str-trim $(echo x/{y,z/{1,2}}/a)))
(test::assert-equal "x/y/a/3 x/y/a/4 x/z/1/a/3 x/z/1/a/4 x/z/2/a/3 x/z/2/a/4" (str-trim $(echo x/{y,z/{1,2}}/a/{3,4})))

(test::assert-equal "z/1 z/2" (str-trim $(echo z/{'(1 2)})))
(test::assert-equal "y z/1 z/2" (str-trim $(echo {y,z/{'(1 2)}})))
(test::assert-equal "y z/1 z/2" (str-trim $(echo {y,z/{(list 1 2)}})))
(test::assert-equal "y z/1 z/2" (str-trim $(echo {y,z/{((fn () '(1 2)))}})))
$(export XXX xxx)
(test::assert-equal "y z/1 z/2 z/xxx" (str-trim $(echo {y,z/{'(1 2), "$XXX"}})))
(test::assert-equal "y z/1 z/2 z/xxx" (str-trim $(echo {y,z/{'(1 2), xxx   }})))
