...
pub fn add_print_builtins(env: &mut SloshVm) {
    bridge_adapters::add_builtin(env, "pr", pr, r#"Usage: (pr value1 value2 ...)
...
"#);
    bridge_adapters::add_builtin(env, "epr", epr, r#"Usage: (epr value1 value2 ...)
...
"#);
    bridge_adapters::add_builtin(env, "prn", prn, r#"Usage: (prn value1 value2 ...)
...
"#);
    bridge_adapters::add_builtin(env, "eprn", eprn, r#"Usage: (eprn value1 value2 ...)
...
"#);
    bridge_adapters::add_builtin(env, "dasm", dasm, r#"Usage: (dasm callable)
...
"#);
    bridge_adapters::add_builtin(env, "fpr", fpr, r#"Usage: (fpr file-handle value1 value2 ...)
...
(close out)
"#);
    bridge_adapters::add_builtin(env, "fprn", fprn, r#"Usage: (fprn file-handle value1 value2 ...)
